/*type DicomTagInfo = [string, string, string];
type DicomTagMap = Record<string, Record<string, DicomTagInfo>>;
type DicomTagGroupMap = Record<string, string>;
*/
import type { DicomTagMap, DicomTagGroupMap } from "../types/dicomTypes";

/* The format is as follows
 *  TagGroup: { Tag: [VR, VM, Name] }
 */

export const DCM_TAG_MAP: DicomTagMap = {
  "0000": {
...
export const DCM_TAG_GROUP_MAP: DicomTagGroupMap = {
  "0002": "Meta Element",
  "0000": "Command",
  "0004": "File Set",
  "0008": "Identifying",
